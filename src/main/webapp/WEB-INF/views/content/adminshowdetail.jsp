...
<div class="navigation">当前位置：订单管理&nbsp;>&nbsp;订单详情&nbsp;>&nbsp;<a href="javascript: history.go(-1);">返回</a></div>
  <!--动态内容-->
...
<%-- 	<c:forEach items="${list}" var="list">
		...
		<div style="width: 50%; margin: auto;">
			<div style="margin: 12px 0px; font-weight: bold; color: #31a3ff;">文章标题：${content.articleTitle }</div>
			<div>${content.articleContents }</div>
		</div>

...
// 	 	alert(cityname);
	...
	if(state==1){
		...
		$.ajax(
		{
			url:'<%=basePath%>content/checkmoney',
			type:'GET',
...
<div class="navigation">当前位置：（客户）订单管理&nbsp;>&nbsp;订单发布&nbsp;>&nbsp;<a href="javascript: history.go(-1);">返回</a></div>
  <!--动态内容-->
 ...
 <form  method="post" action="#" id="content"  style="margin-top: 40px;">
	<div class="detail">
		...
		<div class="itempanel">
			...
			<div class="floatleft editor"><input type="text" id="title" name="title" placeholder="请输入订单标题..." /><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
...
<%-- 	<c:forEach items="${list}" var="list">
		...
		<div class="itempanel">
			...
			<div class="floatleft message" style="width: 100%;margin-left: 7%;">图片尺寸不超过1200px*800px，支持jpg和png格式，大小不超过1000K，请尽量上传该比例图片以确保显示效果。</div>
			<div class="clear"></div>
			<div><img src="" style="width: 120px;height: 120px;margin-left:174px;" id="topimg"/></div>
		</div>	
			
		<div class="itempanel">
			<div class="floatleft title">广告链接：</div>
			<div class="floatleft editor"><input type="text" id="headimgurl" name="headimgurl" placeholder='请输入正确的广告链接...'/><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
		...
		<div class="itempanel">
			...
			<div class="floatleft message" style="width: 100%;margin-left: 7%;">图片尺寸不超过1200px*800px，支持jpg和png格式，大小不超过1000K，请尽量上传该比例图片以确保显示效果。</div>
			<div class="clear"></div>
			<div><img src="" style="width: 120px;height: 120px;margin-left:174px;" id="topimg2"/></div>
		</div>	
		
		<div class="itempanel">
			<div class="floatleft title">广告链接：</div>
			<div class="floatleft editor"><input type="text" id="bottomimgurl" name="bottomimgurl" placeholder="请输入广告链接..."/><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
		...
		<div class="itempanel">
			...
			<div class="floatleft editor">
				<input type="text" id="starttime" maxlength="20" style="width: 180px;" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"   placeholder="请点击选择时间"/>
				至
				<input type="text" id="endtime" maxlength="20" style="width: 180px;" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"    placeholder="请点击选择时间"/>
		...
		<div class="itempanel">
			...
			<div class="floatleft editor"><input type="number" id="totalprice" name="totalprice" placeholder="请输入推广总价"/><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
		...
		<div class="itempanel">
			...
			<div class="floatleft editor"><input type="number" id="cpmprice" name="cpmprice" placeholder="请输入CPM单价"/><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
		...
		<div class="itempanel">
			...
			<div class="floatleft editor"><input type="number" id="cpcprice" name="cpcprice" placeholder="请输入CPC单价"/><div style=" color: red; margin-top: 5px; float: right; ">*</div></div>
...
<!-- 		<div class="itempanel">
		...
		<input type="hidden" id="cpm" name="cpm" value="0"/> <!-- cpm数-->
		<input type="hidden" id="cpc" name="cpc" value="0"/> <!-- cpc数-->
		...
		<input id="photowidth" type="hidden"  value="1200"/>
		<input id="photoheight" type="hidden"  value="800"/>
		<div class="actionbar">
		    <input id="submit_btn2"  class="greenbutton2" style="margin-left: 29px; width: 129px;" onclick="gotoUrl(2)" type="button" value="保存到素材库"/>

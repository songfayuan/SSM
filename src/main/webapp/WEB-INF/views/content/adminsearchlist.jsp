...
<div class="navigation">当前位置：（管理员）订单审核管理&nbsp;>&nbsp;审核列表&nbsp;>&nbsp;<a href="javascript: history.go(-1);">返回</a></div>
...
<%-- 					<button class="button border-other button-little" onclick="publish('${clist.articleContents}',${clist.id});">发布</button> --%>

...
<form name="findForm" id="findForm" action="<%=basePath %>content/detail_list" method="post" style="margin-left: 26px;">
...
<div class="pagestart">
	...
	<div class="pageinfo">
		<button
			onclick="gotopage('<%=basePath%>content/detail_list', '1')"
			<c:if test="${list.pageno == 1}"> class="button3"  disabled</c:if>
			<c:if test="${list.pageno > 1}"> class="button3"</c:if>>首页</button>
		<button
			onclick="gotopage('<%=basePath%>content/detail_list', '${list.pageno-1 }')"
			<c:if test="${list.pageno == 1}"> class="button3"  disabled</c:if>
		...
		<button
			onclick="gotopage('<%=basePath%>content/detail_list', '${list.totalpages }')"
			<c:if test="${list.pageno == list.totalpages}"> class="button3"  disabled</c:if>
